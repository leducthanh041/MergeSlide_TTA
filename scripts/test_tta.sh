...
# ── CLASS-IL TCP (chính) ──────────────────────────────────────────────────────
run_to_logs \
    "$LOG_DIR/result_tta_classil_tcp.log" \
    "$LOG_DIR/error_tta_classil_tcp.log" \
...
# # ── CLASS-IL Naive ────────────────────────────────────────────────────────────
# run_to_logs \
#     "$LOG_DIR/result_tta_classil_naive.log" \
#     "$LOG_DIR/error_tta_classil_naive.log" \
#     "$PYTHON_BIN" -u test_tta.py \
#         --config        "$CONFIG" \
#         --save_dir      "$FINETUNED_DIR" \
#         --merge_model_path "$MERGED_DIR" \
...
# # ── TASK-IL ───────────────────────────────────────────────────────────────────
# run_to_logs \
#     "$LOG_DIR/result_tta_taskil.log" \
#     "$LOG_DIR/error_tta_taskil.log" \
#     "$PYTHON_BIN" -u test_tta.py \
#         --config        "$CONFIG" \
#         --save_dir      "$FINETUNED_DIR" \
#         --merge_model_path "$MERGED_DIR" \
