...
#SBATCH --output=/datastore/uittogether3/LuuTru/Thanhld/WSI/MergeSlide_TTA/logs/finetune_%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/Thanhld/WSI/MergeSlide_TTA/logs/finetune_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
python -u train.py --config configs/default.yaml