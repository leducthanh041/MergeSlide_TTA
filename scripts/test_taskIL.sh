...
#SBATCH --output=/datastore/uittogether3/LuuTru/Thanhld/WSI/MergeSlide_TTA/logs/test_taskIL_%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/Thanhld/WSI/MergeSlide_TTA/logs/test_taskIL_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
