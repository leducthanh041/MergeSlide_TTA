...
python -u TRIDENT/run_batch_of_slides.py --task all --wsi_dir /datastore/uittogether2/LuuTru/Thanhld/WSI/dataset/TCGA-RCC/ --job_dir /datastore/uittogether2/LuuTru/Thanhld/WSI/dataset/TCGA-RCC/preprocessed/ --patch_encoder conch_v15 --mag 10 --patch_size 256