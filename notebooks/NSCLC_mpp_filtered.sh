#!/bin/bash
#SBATCH --job-name=NSCLC_mpp_filtered
#SBATCH --output=/datastore/uittogether3/LuuTru/Thanhld/WSI/MergeSlide_TTA/notebooks/log/NSCLC_mpp_filtered_%j.out
#SBATCH --error=/datastore/uittogether3/LuuTru/Thanhld/WSI/MergeSlide_TTA/notebooks/log/NSCLC_mpp_filtered_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
WSI_DIR="${WSI_DIR:-/datastore/uittogether3/LuuTru/Thanhld/WSI/dataset/TCGA-NSCLC}"
JOB_DIR="${JOB_DIR:-${WSI_DIR}/preprocessed}"
CUSTOM_WSI_LIST="${CUSTOM_WSI_LIST:-${PROJECT_ROOT}/log/TCGA-NSCLC_trident_wsi_with_mpp.csv}"
SKIPPED_WSI_LIST="${SKIPPED_WSI_LIST:-${PROJECT_ROOT}/log/TCGA-NSCLC_trident_skipped_missing_mpp.csv}"
